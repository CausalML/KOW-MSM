...
for (nn in seqqn) {
  ...
  for(ii in 1:ite){
    ...
    if (class(result) != "try-error") {
      ...
      #save.image("/home/micsan/research/Research/projects/Cornell/Longitudinal/data/simu_291117_LL_linpoly1_nn.RData")
  ...
  save.image("/home/micsan/research/Research/projects/Cornell/Longitudinal/data/simu_291117_LL_linpoly1_nn_3.RData")
