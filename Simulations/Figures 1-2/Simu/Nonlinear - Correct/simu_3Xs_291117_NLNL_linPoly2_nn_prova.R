...
seqqn <- seq(600,1000,length.out = 8)
...
for (nn in seqqn) {
  ...
  for(ii in 1:ite){
    ...
    data <- read.table(file=paste("/home/micsan/research/Research/projects/Cornell/Longitudinal/data/Longdata3X_NL_NL_211117_nn",nn,"_repp",REP,"_",ii,".csv",sep=""), header=T)
    ...
    for(t in 1:max(unique(data$time))){
      ...
      if(t==1){
        ...
        gpmlres <-  gpml(data$y[which(data$time==t)],X,1,t)
      ...
      if(t>1){
        ...
        gpmlres <- gpml(data$y[which(data$time==t)],Xt,At,t)
    ...
    if (class(result) != "try-error") {
      ...
      #save.image("/home/micsan/research/Research/projects/Cornell/Longitudinal/data/simu_291117_NLNL_linpoly2_nn.RData")
  ...
  save.image("/home/micsan/research/Research/projects/Cornell/Longitudinal/data/simu_291117_NLNL_linpoly2_nn_3.RData")
}     
