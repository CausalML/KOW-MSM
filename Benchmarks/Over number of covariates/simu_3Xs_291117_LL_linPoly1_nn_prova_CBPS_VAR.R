...
MA_TIME_TEMP  <- MA_TIME_TEMPA  <- matrix(NA,nrow=ite,ncol=length(seqqVAR))
...
for (vvv in seqqVAR) {
  ...
  jj <- jj+1
  print(nn)
  print(paste("############################################################################################################################################################### Iteration ", jj, "out of ", length(seqqVAR)))
  for(ii in 1:ite){
    print(paste("###############################################################################################################################################################", ii))
    ...
    data <- read.table(file=paste("/home/micsan/research/Research/projects/Cornell/Longitudinal/data/Longdata3X_L_L_211117_VAR",vvv,ttt,"_repp",REP,"_",ii,".csv",sep=""), header=T)
    ...
    if(vvv==4){
      dat1 <- data.frame(as.factor(data$ID),data$time,data$X1,data$X2,data$X3,data$X4,data$TreatmentIPW,data$Treatment)
      colnames(dat1) <- c("ID","time","X1","X2","X3","X4","TreatmentIPW","Treatment")
      form0 <- "Treatment ~ TreatmentIPW + X1 + X2 + X3 + X4 + TreatmentIPW:X1 + TreatmentIPW:X2 + TreatmentIPW:X3+ TreatmentIPW:X4"
    }
    if(vvv==5){
      dat1 <- data.frame(as.factor(data$ID),data$time,data$X1,data$X2,data$X3,data$X4,data$X5,data$TreatmentIPW,data$Treatment)
      colnames(dat1) <- c("ID","time","X1","X2","X3","X4","X5","TreatmentIPW","Treatment")
      form0 <- "Treatment ~ TreatmentIPW + X1 + X2 + X3 + X4 + X5  + TreatmentIPW:X1 + TreatmentIPW:X2 + TreatmentIPW:X3 + TreatmentIPW:X4 + TreatmentIPW:X5"
    }
    if(vvv==6){
      dat1 <- data.frame(as.factor(data$ID),data$time,data$X1,data$X2,data$X3,data$X4,data$X5,data$X6,data$TreatmentIPW,data$Treatment)
      colnames(dat1) <- c("ID","time","X1","X2","X3","X4","X5","X6","TreatmentIPW","Treatment")
      form0 <- "Treatment ~ TreatmentIPW + X1 + X2 + X3 + X4 + X5 +X6 + TreatmentIPW:X1 + TreatmentIPW:X2 + TreatmentIPW:X3 + TreatmentIPW:X4 + TreatmentIPW:X5 + TreatmentIPW:X6 "
    }
    
    if(vvv==7){
      dat1 <- data.frame(as.factor(data$ID),data$time,data$X1,data$X2,data$X3,data$X4,data$X5,data$X6,data$X7,data$TreatmentIPW,data$Treatment)
      colnames(dat1) <- c("ID","time","X1","X2","X3","X4","X5","X6","X7","TreatmentIPW","Treatment")
      form0 <- "Treatment ~ TreatmentIPW + X1 + X2 + X3 + X4 + X5 +X6+X7 + TreatmentIPW:X1 + TreatmentIPW:X2 + TreatmentIPW:X3 + TreatmentIPW:X4 + TreatmentIPW:X5 + TreatmentIPW:X6  + TreatmentIPW:X7  "
    }
    
    if(vvv==8){
      dat1 <- data.frame(as.factor(data$ID),data$time,data$X1,data$X2,data$X3,data$X4,data$X5,data$X6,data$X7,data$X8,data$TreatmentIPW,data$Treatment)
      colnames(dat1) <- c("ID","time","X1","X2","X3","X4","X5","X6","X7","X8","TreatmentIPW","Treatment")
      form0 <- "Treatment ~ TreatmentIPW + X1 + X2 + X3 + X4 + X5 +X6+X7+X8 + TreatmentIPW:X1 + TreatmentIPW:X2 + TreatmentIPW:X3 + TreatmentIPW:X4 + TreatmentIPW:X5 + TreatmentIPW:X6 + TreatmentIPW:X7 + TreatmentIPW:X8 "
      # form0 <- "Treatment ~ TreatmentIPW + X1 + X2 + X3 + X4 + X5 +X6+X7+X8 + 
      # TreatmentIPW:X1 + TreatmentIPW:X2 + TreatmentIPW:X3 + TreatmentIPW:X4 + TreatmentIPW:X5 + TreatmentIPW:X6 + TreatmentIPW:X7 + TreatmentIPW:X8 +
    ...
    save.image("/home/micsan/research/Research/projects/Cornell/Longitudinal/data/Longdata3X_L_L_TIME_REP5_VAR3_8_CBPS.RData")
