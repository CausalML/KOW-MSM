...
for(i in 1:ite){
  ...
  write.table (anal.data, file=paste("/home/micsan/research/Research/projects/Cornell/Longitudinal/data/Longdata3X_L_L_211117_VAR3",tt,"_repp",REP,"_",i,".csv",sep=""), row.names=F)
  #print(i)
