...
evaluate(matlab, "oldpath = path;
         path('/Users/micsan/Documents/MATLAB/gpml-matlab-v4.1-2017-10-19/',oldpath)")

evaluate(matlab, "oldpath = path;
         path('/Users/micsan/Documents/MATLAB/gpml-matlab-v4.1-2017-10-19/cov',oldpath)")

evaluate(matlab, "oldpath = path;
         path('/Users/micsan/Documents/MATLAB/gpml-matlab-v4.1-2017-10-19/doc',oldpath)")

evaluate(matlab, "oldpath = path;
         path('/Users/micsan/Documents/MATLAB/gpml-matlab-v4.1-2017-10-19/inf',oldpath)")

evaluate(matlab, "oldpath = path;
         path('/Users/micsan/Documents/MATLAB/gpml-matlab-v4.1-2017-10-19/lik',oldpath)")

evaluate(matlab, "oldpath = path;
         path('/Users/micsan/Documents/MATLAB/gpml-matlab-v4.1-2017-10-19/mean',oldpath)")

evaluate(matlab, "oldpath = path;
         path('/Users/micsan/Documents/MATLAB/gpml-matlab-v4.1-2017-10-19/prior',oldpath)")

evaluate(matlab, "oldpath = path;
         path('/Users/micsan/Documents/MATLAB/gpml-matlab-v4.1-2017-10-19/util',oldpath)")
...
KGram <- function(XX,AA,t,scale1,scale){
  ...
  if(t==1){
    spl <- polydot(degree = 1, scale = scale, offset = 1)
...
for(t in 1:max(unique(dta$tempv))){
  ...
  if (class(result) != "try-error") {
    if(t>1){
      ...
      #Qt <-   (     (1/nt)*(tempMa11 -2*tempMa11e + tempMaeeK + lambda0*IC11) +
      ...
      #ct <- -(2*((lambda0*a1*c1/nt) + (lambda0*a1*c0/nt) + (lambda0*a0*c1/nt) + (lambda0*a0*c0/nt) ))
...
time_temp <- benchmark(WW <- optimize(dta),replications = 1)$elapsed
...
#save.image("Wcomplete3_noLBbounds.RData")
